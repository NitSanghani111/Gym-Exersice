...
<section className="bg-white dark:bg-gray-900">
        <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                <h2 className="mb-4 text-4xl font-extrabold text-gray-900 dark:text-white">Welcome to BodyCraft - Where Fitness Becomes a Lifestyle</h2>
                <p className="mb-4">At BodyCraft, we believe in the transformative power of fitness. Established with a passion for fostering a healthier community, we have dedicated ourselves to providing a space where individuals of all fitness levels can embark on their wellness journey.</p>
            </div>
            <div className="grid grid-cols-2 gap-4 mt-8">
                <img className="w-full rounded-lg" src="https://th.bing.com/th/id/OIP.Q5-7VFX0tplomNxMpkZq2wHaFj?w=202&h=180&c=7&r=0&o=5&dpr=2.2&pid=1.7" alt="office content 1"/>
                <img className="mt-4 w-full lg:mt-10 rounded-lg" src="https://th.bing.com/th/id/OIP._v951IX6jdy2JIhkGSdqtAHaJ4?w=116&h=180&c=7&r=0&o=5&dpr=2.2&pid=1.7g" alt="office content 2"/>
            </div>
        </div>
    </section>
    ...
    <section className="bg-gray-50 dark:bg-gray-900 dark:bg-gray-800">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div className="max-w-screen-lg text-gray-500 sm:text-lg dark:text-gray-400">
                <h2 className="mb-4 text-4xl font-bold text-gray-900 dark:text-white"> Strength of Our Gym  <span className="font-extrabold">1000+</span>Member</h2>
                <p className="mb-4 font-light">Our story begins with a vision of creating more than just a gym; we aspired to build a fitness haven that inspires and motivates. [BodyCraft] was founded by [Nit Patel] in [2020], driven by a mission to make fitness accessible, enjoyable, and inclusive for everyone.</p>
                <p className="mb-4 font-medium">At the core of [Your Gym Name]'s philosophy is the belief that fitness is not just a routine; it's a lifestyle. We emphasize a holistic approach to well-being, combining state-of-the-art facilities with expert guidance to help you achieve your fitness goals and maintain a balanced and healthy life..</p>
      ...
      <section className="bg-gray-50 dark:bg-gray-800">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div className="max-w-screen-md mb-8 lg:mb-16">
                <h2 className="mb-4 text-4xl font-extrabold text-gray-900 dark:text-white">State-of-the-Art Facilities</h2>
                <p className="text-gray-500 sm:text-xl dark:text-gray-400">We are dedicated to creating an environment where everyone feels welcome, regardless of their fitness level, background, or age.</p>
            </div>
            <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div>
                    ...
                    <h3 className="mb-2 text-xl font-bold dark:text-white">Commitment to Inclusivity</h3>
                    <p className="text-gray-500 dark:text-gray-400">We commit to offering state-of-the-art facilities, cutting-edge equipment, and expert guidance to ensure our members have the tools they need for success.</p>
                </div>
                <div>
                    <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-blue-900">
                    ...
                    <h3 className="mb-2 text-xl font-bold dark:text-white">Excellence in Fitness</h3>
                ...
                <div>
                    ...
                    <h3 className="mb-2 text-xl font-bold dark:text-white">Holistic Wellness</h3>
                    <p className="text-gray-500 dark:text-gray-400">We emphasize a holistic approach to health, focusing not only on physical fitness but also on mental well-being. We provide resources and guidance for a well-rounded, balanced lifestyle..</p>
                </div>
                <div>
                    <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-blue-900">
                    ...
                    <h3 className="mb-2 text-xl font-bold dark:text-white">ennovation and Adaptability:</h3>
                ...
                <div>
                    ...
                    <h3 className="mb-2 text-xl font-bold dark:text-white">Community and Support</h3>
                ...
                <div>
                    ...
                    <h3 className="mb-2 text-xl font-bold dark:text-white">Social Responsibility</h3>
